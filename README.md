...
Для решения поставленных задач имплементируем алгоритм Proximal Policy Optimization. Основная задача состоит в разработке функции награды и определении данных, доступных моделям. 

...
from utils import make_ppo_runner, evaluate, Policy
    ...
    while current_number_of_steps <= max_updates:
        ...
        if i % 100 == 0:
            ...
            if  best_rewards < rewards:
                ...
                torch.save(policy.model.policy.state_dict(), 'ppo_policy.pth')
                torch.save(policy.model.value.state_dict(), 'ppo_value.pth')
